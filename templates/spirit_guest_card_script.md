SPIRIT MASTER GUEST CARD v2 - new spiritre.com account - paste and fill
...
SUBJECT
Guest Card & Client Registration: [CLIENT NAME] | [PROPERTY] | Locator: Sophia Reddehase, Spirit Real Estate Group, TREC #831516

BODY
Hello [PROPERTY] leasing team,

Registering a client with your community. Please place the following prospect under my representation as locator of record before any tour, application, or quote.
...
[PHONE]
[EMAIL]
Looking for: [BEDS/BATHS], around [BUDGET]
Move-in: [WINDOW]
Lease term: [12 months / shortest available / flexible]
Must-haves: [HARD REQUIREMENTS, one line]

FILE NOTES
[Anything the screener will find anyway: income multiple, credit range, voucher, visa/passport only, pets, co-signer. One or two plain sentences. Delete this block if the file is clean.]

PLEASE CONFIRM IN WRITING
1. Units open in the move-in window: unit number, floor, square footage, base rent, and net effective rent with any special applied.
2. Every mandatory monthly fee on top of base rent (trash, pest, valet, package, tech, admin) so I can quote a true monthly number.
3. Full move-in cost due at signing: application, admin, deposit or deposit alternative, pet fees, and any other one-time charge.
...
=====================================================
2. BROKERAGE UPDATE - properties that already hold a card under One Place or under your Gmail address

SUBJECT
Records update on [CLIENT NAME]'s guest card | Locator: Sophia Reddehase, Spirit Real Estate Group, TREC #831516
...
=====================================================
3. NO-REPLY NUDGE - 48 hours after a card with no answer

SUBJECT
Re: Guest Card & Client Registration: [CLIENT NAME] | [PROPERTY]
...
=====================================================
4. PAID APPLICATION, NAME NOT ON FILE - escalation

SUBJECT
Locator of Record Correction Needed Before Lease Execution: [CLIENT NAME] | [PROPERTY]
...
I would like this settled before the lease is executed, not after.
